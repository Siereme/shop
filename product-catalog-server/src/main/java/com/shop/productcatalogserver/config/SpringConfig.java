...
@Configuration
@ComponentScan(basePackages = "com.shop.productcatalogserver")
@EnableTransactionManagement
@EnableJpaRepositories(value = "com.shop.productcatalogserver.repository")
public class SpringConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.shop.productcatalogserver");
