...
class CategoryRepositoryTest {
    ...
    void testFindByDepth() {
        ...
        Assertions.assertEquals(checkCategoryList.get(0).getPath(), categories.get(0).getPath());
        ...
        Assertions.assertEquals(checkCategoryList.get(1).getPath(), categories.get(1).getPath());
        ...
        Assertions.assertEquals(checkCategoryList.get(2).getPath(), categories.get(2).getPath());
        ...
        Assertions.assertEquals(checkCategoryList.get(3).getPath(), categories.get(3).getPath());
    ...
    void testFindByIdWithProducts() {
        ...
        Assertions.assertEquals("1/2/", category.getPath());
        Assertions.assertEquals(2, category.getDepth());

        //Check product collections
        Assertions.assertEquals(2, category.getProducts().size());
        Assertions.assertEquals(2, category.getProducts().iterator().next().getId());
        Assertions.assertEquals(359195, category.getProducts().iterator().next().getArticle());
    }
}