...
public class TestProductConstructor {
    ...
    private void construct() {
        ...
        product1.setTitle("Смартфон Vivo Y53s 128Gb 6Gb глубокое море");
        ...
        product2.setTitle("Смартфон Samsung Galaxy S21 SM-G991 256Gb 8Gb белый");
        ...
        product3.setTitle("Планшет Huawei MatePad Pro 8 128 Gb WiFi Grey M-Pencil");
        ...
        product4.setTitle("Планшет Xiaomi Mi Pad 5 RU 6 128 Pearl White");
        ...
        product5.setTitle("Фитнес-браслет Xiaomi Mi Smart Band 6 XMSH15HM");
        ...
        product6.setTitle("Часы-телефон JET PHONE SP1 черный");
        ...
        product7.setTitle("Электронная книга PocketBook 628 Ink Ruby Red (PB628-R-CIS)");
        ...
        product8.setTitle("Электронная книга PocketBook 970 Mist Grey (PB970-M-CIS)");
