package com.shop.shoppingcartserver.config;
...
@Configuration
@ComponentScan(basePackages = "com.shop.shoppingcartserver")
@EnableTransactionManagement
@EnableJpaRepositories(value = "com.shop.shoppingcartserver.repository")
public class SpringConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.shop.shoppingcartserver");
