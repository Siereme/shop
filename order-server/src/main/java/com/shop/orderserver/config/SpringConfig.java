...
@Configuration
@ComponentScan(basePackages = "com.shop.orderserver")
@EnableTransactionManagement
@EnableJpaRepositories(value = "com.shop.orderserver.repository")
public class SpringConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.shop.orderserver");
