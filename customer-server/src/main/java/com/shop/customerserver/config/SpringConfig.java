...
@Configuration
@ComponentScan(basePackages = "com.shop.customerserver")
@EnableTransactionManagement
@EnableJpaRepositories(value = "com.shop.customerserver.repository")
public class SpringConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.shop.customerserver");
